from core.api.serializers import (
    SellerSerializer, ShopSerializer, ProductSerializer, Sold_ItemSerializer
    )
from core.models import Seller, Shop, Product, Sold_Item
...
class ShopViewSet(mixins.CreateModelMixin,
    ...
    def perform_create(self, serializer):
        ...
        latitude, longitude = lat_lon(
            self.request.data['address']+' '+self.request.data['city']
            )
